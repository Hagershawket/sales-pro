            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.Update Productttt')); ?></h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" id="code" value="<?php echo e($lims_product_data->code); ?>" class="form-control" required readonly>
        ...
        init: function () {
            ...
            $('#submit-btn').on("click", function (e) {
                ...
                if ( $("#product-form").valid() && validate() ) {
                    tinyMCE.triggerSave();
                    if(myDropzone.getAcceptedFil@extends('layout.main')
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\YRmarket\V8\resources\views/product/edit.blade.php ENDPATH**/ ?>