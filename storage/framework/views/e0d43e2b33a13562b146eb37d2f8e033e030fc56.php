...
<html>
  ...
  <body onload="myFunction()">
              ...
              <li><a href="<?php echo e(url('/')); ?>"> <i class="dripicons-meter"></i><span><?php echo e(__('file.dashboard')); ?></span></a></li>
               <?php
                  ...
                  $stock_count = DB::table('permissions')->where('name', 'stock_count')->first();
                      ...
                      $e_stock = DB::table('permissions')->where('name', 'e_stock')->first();
                      $e_stock_active = DB::table('role_has_permissions')->where([
                          ['permission_id', $e_stock->id],
                          ['role_id', $role->id]
                      ])->first();
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span><?php echo e(__('file.product')); ?></span><span></a>
                <ul id="product" class="collapse list-unstyled ">
                  ...
                  <li id="product-create-menu">
                      <a href="#" data-toggle="modal" data-target="#addProduct"><?php echo e(__('file.add_product')); ?></a>
                  </li>
                  <?php endif; ?>
                  <?php endif; ?>
                  ...
                  <?php endif; ?>
                  <?php if($e_stock_active): ?>
                    <li id="e-stock-menu"><a href="<?php echo e(route('e-stock.create')); ?>">E-Stock</a></li>
                  <?php endif; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    ...
                    <?php 
                      $lims_expense_category_list = DB::table('expense_categories')->where('is_active', true)->where('vendor_id', Auth::user()->v_id)->get();
                      if(Auth::user()->role_id > 2)
                        ...
                        $lims_warehouse_list = DB::table('warehouses')->where('is_active', true)->where('vendor_id', Auth::user()->v_id)->get();
                      $lims_account_list = \App\Account::where('is_active', true)->where('vendor_id', Auth::user()->v_id)->get();
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <?php echo Form::open(['route' => 'products.create', 'method' => 'post']); ?>
        ...
        <div class="modal-body">
            <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
              <?php echo Form::open(['route' => 'products.create2', 'method' => 'post']); ?>
              ...
              <?php echo Form::open(['route' => 'products.create', 'method' => 'get']); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    ...
                    <?php 
                      $lims_user_list = DB::table('users')->where('is_active', true)->where('v_id', Auth::user()->v_id)->get();
                    ?>
                      <div class="form-group">
                          <label><?php echo e(trans('file.User')); ?> *</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    ...
                    <?php 
                      $lims_customer_list = DB::table('customers')->where('is_active', true)->where('vendor_id', Auth::user()->v_id)->get();
                    ?>
                      <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    ...
                    <?php 
                      $lims_supplier_list = DB::table('suppliers')->where('is_active', true)->where('vendor_id', Auth::user()->v_id)->get();
                    ?>
                      <div class="form-group">
    ...
    <script type="text/javascript">
      ...
      $("a#product-create-link").click(function(e){
        e.preventDefault();
        $('#product-modal').modal();
      });
...
</html><?php /**PATH D:\xampp\htdocs\YRmarket_old\final\resources\views/layout/main.blade.php ENDPATH**/ ?>