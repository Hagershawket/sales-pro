      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            ...
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('save.admin.login')); ?>" id="login-form">
              <?php echo csrf_field(); ?>
...
</script><?php /**PATH D:\xampp\htdocs\YRmarket\V8\resources\views/auth/adminlogin.blade.php ENDPATH**/ ?>