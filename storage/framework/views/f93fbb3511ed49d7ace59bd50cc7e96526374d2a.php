                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" aria-describedby="name" required  value="<?php echo e($default_product_data->name); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" class="form-control" id="code" aria-describedby="code" required readonly value="<?php echo e($default_product_data->code); ?>">
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="hidden" name="barcode_symbology_hidden" value="<?php echo e($default_product_data->barcode_symbology); ?>">
                                ...
                                <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="cost" required class="form-control" step="any" value="<?php echo e($default_product_data->cost); ?>">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" required class="form-control" step="any" value=<?php echo e($default_product_data->price); ?>>
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="alert_quantity" class="form-control" step="any" value="<?php echo e($default_product_data->alert_quantity); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php $images = explode(",", $default_product_data->image)?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_details" class="form-control" rows="3" ><?php echo e(str_replace('@', '"', $default_product_data->product_details)); ?></textarea>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    myDropzone = new Dropzone('div#imageUpload', {
        ...
        clickable: true,
        method: 'POST',
        url: '<?php echo e(route('products.store2')); ?>',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\YRmarket_old\final\resources\views/product/create2.blade.php ENDPATH**/ ?>