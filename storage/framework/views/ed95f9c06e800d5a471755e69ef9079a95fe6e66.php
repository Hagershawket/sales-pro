...
<section>
    <?php if(in_array("users-add", $all_permission)): ?>
        <div class="container-fluid">
            <a href="<?php echo e(route('vendor.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add Vendor')); ?></a>
        </div>
    <?php endif; ?>
        ...
        <table id="user-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.End Time')); ?></th>
                    <th><?php echo e(trans('file.Off Day')); ?></th>
                    <th><?php echo e(trans('file.Facebook')); ?></th>
                    <th><?php echo e(trans('file.Instagram')); ?></th>
                    <th><?php echo e(trans('file.Twitter')); ?></th>
                    <th><?php echo e(trans('file.Status')); ?></th>
                    <th class="not-exported"><?php echo e(trans('file.action')); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php $__currentLoopData = $lims_vendor_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr data-id="<?php echo e($vendor->id); ?>">
                    <td><?php echo e($key); ?></td>
                    <?php if($vendor->image): ?>
                    <td><img src="<?php echo e(url('public/images/vendor', $vendor->image)); ?>" height="70px" width="70px"></td>
                    <?php else: ?>
                    <td><img src="<?php echo e(url('public/images/product/zummXD2dvAtI.png')); ?>" height="70px" width="70px"></td>
                    <?php endif; ?>
                    <td><?php echo e($vendor->name); ?></td>
                    <td><?php echo e($vendor->address); ?></td>
                    <td><?php echo e($vendor->phone); ?></td>
                    <td><?php echo e($vendor->start_time); ?></td>
                    <td><?php echo e($vendor->end_time); ?></td>
                    <td><?php echo e($vendor->off_day); ?></td>
                    <td><?php echo e($vendor->social_list[0]); ?></td>
                    <td><?php echo e($vendor->social_list[1]); ?></td>
                    <td><?php echo e($vendor->social_list[2]); ?></td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                	<a href="<?php echo e(route('vendor.edit', $vendor->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
                                <?php if(in_array("users-delete", $all_permission)): ?>
                                <?php echo e(Form::open(['route' => ['vendor.destroy', $vendor->id], 'method' => 'DELETE'] )); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\YRmarket\V8\resources\views/vendor/index.blade.php ENDPATH**/ ?>