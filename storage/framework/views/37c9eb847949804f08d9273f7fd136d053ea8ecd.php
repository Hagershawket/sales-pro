...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        ...
        <p><?php echo e(trans('file.Date')); ?>: <?php echo e($lims_sale_data->created_at); ?><br>
            <?php echo e($lims_sale_data->Variant_id); ?>
        ...
        <table>
            <tbody>
                ...
                <?php
                    ...
                    if($product_sale_data->variant_id!=-1) {
                        $variant_data = \App\ProductVariant::find($product_sale_data->variant_id);
                        //echo $variant_data->variant_id;
                        $varident_Name = \App\Variant::find($variant_data->variant_id);
                        //echo $varident_Name->name;
                         $product_name = $lims_product_data->name.' ['.$varident_Name->name.']';
                    }
                    else
...
<?php /**PATH /home/yrnovaon/public_html/yrmarket8.2/resources/views/sale/invoice.blade.php ENDPATH**/ ?>