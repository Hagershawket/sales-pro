...
<section>
    <?php if(in_array("vendors-add", $all_permission)): ?>
        <div class="container-fluid">
            <a href="<?php echo e(route('vendors.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add Vendor')); ?></a>
        </div>
    <?php endif; ?>
        ...
        <table id="user-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Admin Name')); ?></th>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($vendor->id); ?>">
                    ...
                    <?php if($vendor->image): ?>
                    <td><img src="<?php echo e(url('public/images/vendor', $vendor->image)); ?>" class="rounded mr-3" height="70px" width="70px"></td>
                    <?php else: ?>
                    <td><img src="<?php echo e(url('public/images/product/zummXD2dvAtI.png')); ?>" class="rounded mr-3" height="80px" width="80px"></td>
                    <?php endif; ?>
                    ...
                    <?php 
                        $admin = DB::table('users')->find($vendor->admin_id);
                    ?>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <?php if(in_array("superadmins-edit", $all_permission)): ?>
                                <li>
                                	<a href="<?php echo e(route('vendors.edit', $vendor->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
                                <?php if(in_array("superadmins-delete", $all_permission)): ?>
...
<?php echo $__env->make('admins.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\YRmarket_old\final\resources\views/admins/vendor/index.blade.php ENDPATH**/ ?>