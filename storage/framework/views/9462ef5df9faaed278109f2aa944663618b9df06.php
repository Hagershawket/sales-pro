        ...
        <table id="cash-register-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Total Cash')); ?></th>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($cash_register->id); ?>">
                    ...
                    <?php 
                    $total_payment = DB::table('payments')->where('cash_register_id', $cash_register->id)->sum('amount');
                    $total_sale_return =  DB::table('returns')->where('cash_register_id', $cash_register->id)->sum('grand_total');
                    $total_expense = DB::table('expenses')->where('cash_register_id', $cash_register->id)->sum('amount');
                    $total_cash = $cash_register->cash_in_hand + $total_payment - ($total_sale_return + $total_expense);
                ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\YRmarket_old\final\resources\views/cash_register/index.blade.php ENDPATH**/ ?>