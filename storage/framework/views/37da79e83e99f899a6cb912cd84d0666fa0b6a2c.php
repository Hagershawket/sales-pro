...
<section>
    <?php if(in_array("superadmins-add", $all_permission)): ?>
        <div class="container-fluid">
            <a href="<?php echo e(route('admin.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add SuperAdmin')); ?></a>
        </div>
    <?php endif; ?>
    <div class="table-responsive">
        <table id="user-table" class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $lims_admin_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr data-id="<?php echo e($admin->id); ?>">
                    <td><?php echo e($key); ?></td>
                    <td><?php echo e($admin->name); ?></td>
                    <td><?php echo e($admin->email); ?></td>
                    <td><?php echo e($admin->phone); ?></td>
                    <?php $role = DB::table('roles')->find($admin->role_id);?>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                	<a href="<?php echo e(route('admin.edit', $admin->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
                                <?php if(in_array("superadmins-delete", $all_permission)): ?>
                                <?php echo e(Form::open(['route' => ['admin.destroy', $admin->id], 'method' => 'DELETE'] )); ?>
...
<?php echo $__env->make('admins.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\YRmarket_old\yrmarket8.2\resources\views/admins/superadmin/index.blade.php ENDPATH**/ ?>