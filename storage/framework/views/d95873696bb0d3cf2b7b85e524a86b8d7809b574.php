      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo"><span>Admin <?php echo e($general_setting->site_title); ?></span></div>
            ...
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('login.admin')); ?>" id="login-form">
              <?php echo csrf_field(); ?>
...
</script><?php /**PATH D:\xampp\htdocs\YRmarket_old\yrmarket8.2\resources\views/admins/auth/adminlogin.blade.php ENDPATH**/ ?>