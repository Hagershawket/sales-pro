                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" aria-describedby="name" required  value="{{$default_product_data->name}}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" class="form-control" id="code" aria-describedby="code" required readonly value="{{$default_product_data->code}}">
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="hidden" name="barcode_symbology_hidden" value="{{$default_product_data->barcode_symbology}}">
                                ...
                                <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="cost" required class="form-control" step="any" value="{{$default_product_data->cost}}">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" required class="form-control" step="any" value={{$default_product_data->price}}>
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="alert_quantity" class="form-control" step="any" value="{{$default_product_data->alert_quantity}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_details" class="form-control" rows="3" >{{str_replace('@', '"', $default_product_data->product_details)}}</textarea>
                                    </div>
                                </div>
