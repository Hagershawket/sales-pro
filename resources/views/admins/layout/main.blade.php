            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#superadmin" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-card"></i><span>SuperAdmin</span></a>
                <ul id="superadmin" class="collapse list-unstyled ">
                  <li id="superadmin-list-menu"><a href="{{route('admin.index')}}">{{__('file.SuperAdmin List')}}</a></li>
                  <?php 
                  ...
                  <li id="superadmin-create-menu"><a href="{{route('admin.create')}}">{{__('file.Add SuperAdmin')}}</a></li>
                  @endif
                  <?php 
                  ...
                  ?>
                  @if($add_permission_active)
                  <li id="vendor-create-menu"><a href="{{route('vendors.index')}}">{{__('file.Vendor List')}}</a></li>
                  @endif
                </ul>
              </li>
              @endif
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>{{__('file.product')}}</span><span></a>
                <ul id="product" class="collapse list-unstyled ">
                  ...
                  @endif
                  @if($index_permission_active)
                  <li id="product-list-menu"><a href="{{route('admin.products.index')}}">{{__('file.product_list')}}</a></li>
                  <?php 
                  ...
                  <li id="product-create-menu">
                      <a href="{{route('admin.products.create')}}">{{__('file.add_product')}}</a>
                  </li>
                  @endif
                  @endif
                  @if($print_barcode_active)
                  <li id="printBarcode-menu"><a href="{{route('admin.product.printBarcode')}}">{{__('file.print_barcode')}}</a></li>
                  @endif
             ...
             {{-- <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
               ...
               <li id="user-menu"><a href="{{route('user.profile', ['id' => Auth::guard('admin')->user()->id])}}">{{trans('file.User Profile')}}</a></li>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                ?>
                @if($product_qty_alert_active)
                  @if(($alert_product + count(\Auth::guard('admin')->user()->unreadNotifications)) > 0)
                  <li class="nav-item" id="notification-icon">
                        <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="dripicons-bell"></i><span class="badge badge-danger notification-number">{{$alert_product + count(\Auth::guard('admin')->user()->unreadNotifications)}}</span>
                        </a>
                  ...
                  @elseif(count(\Auth::guard('admin')->user()->unreadNotifications) > 0)
                  <li class="nav-item" id="notification-icon">
                        <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="dripicons-bell"></i><span class="badge badge-danger notification-number">{{count(\Auth::guard('admin')->user()->unreadNotifications)}}</span>
                        </a>
                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                            @foreach(\Auth::guard('admin')->user()->unreadNotifications as $key => $notification)
                                <li class="notifications">
                ...
                @endif
                <li class="nav-item">
                  <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="dripicons-user"></i> <span>{{ucfirst(Auth::guard('admin')->user()->name)}}</span> <i class="fa fa-angle-down"></i>
                  </a>
                  <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                      
                      <li> 
                        <a href="{{route('user.profile', ['id' => Auth::guard('admin')->user()->id])}}"><i class="dripicons-user"></i> {{trans('file.profile')}}</a>
                      </li>
    ...
    <div class="page">
      ...
      <div id="product-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title">{{trans('file.Default Product')}}</h5>
                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                </div>
                <div class="modal-body">
                  <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                    {!! Form::open(['route' => 'admin.products.create', 'method' => 'get']) !!}
                      ...
                      <div class="form-group">
                          <button type="submit" class="btn btn-primary">{{trans('file.submit')}}</button>
                          <button type="submit" class="btn btn-primary mr-4">+ {{trans('file.Add New Code')}}</button>
                      </div>
                    {{ Form::close() }}
                </div>
            </div>
