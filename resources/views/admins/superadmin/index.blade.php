...
<section>
    @if(in_array("superadmins-add", $all_permission))
        <div class="container-fluid">
            <a href="{{route('admin.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Add SuperAdmin')}}</a>
        </div>
    @endif
    <div class="table-responsive">
        <table id="user-table" class="table">
            ...
            <tbody>
                @foreach($lims_admin_list as $key=>$admin)
                <tr data-id="{{$admin->id}}">
                    <td>{{$key}}</td>
                    <td>{{ $admin->name }}</td>
                    <td>{{ $admin->email}}</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                	<a href="{{ route('admin.edit', $admin->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                </li>
                                @endif
                                <li class="divider"></li>
