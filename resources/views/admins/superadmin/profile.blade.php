            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['admin.profileUpdate', Auth::id()], 'method' => 'put']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{trans('file.UserName')}} *</strong> </label>
                                    <input type="text" name="name" value="{{$lims_admin_data->name}}" required class="form-control" />
                                    @if($errors->has('name'))
                                    <span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="{{$lims_admin_data->email}}" class="form-control">
                                    @if($errors->has('email'))
                                    <span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" value="{{$lims_admin_data->phone}}" required class="form-control" />
                                </div>
                                <div class="form-group">
