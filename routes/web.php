...
//routes of SuperAdmin
Route::prefix('admin')->name('admin.')->group(function(){
	//Route::post('superadmin/deletebyselection', 'SuperAdminController@deleteBySelection');
//Route::get('products/getbarcode', 'ProductController@getBarcode');
Route::post('products/product-data', 'SuperAdmin\ProductController@productData')->middleware('auth:admin');
Route::get('products/gencode', 'SuperAdmin\ProductController@generateCode')->middleware('auth:admin');
Route::get('products/search', 'SuperAdmin\ProductController@search')->middleware('auth:admin');
Route::get('products/saleunit/{id}', 'SuperAdmin\ProductController@saleUnit')->middleware('auth:admin');
Route::get('products/getdata/{id}', 'SuperAdmin\ProductController@getData')->middleware('auth:admin');
Route::get('products/product_warehouse/{id}', 'SuperAdmin\ProductController@productWarehouseData')->middleware('auth:admin');
Route::post('importproduct', 'SuperAdmin\ProductController@importProduct')->name('product.import')->middleware('auth:admin');
Route::post('exportproduct', 'SuperAdmin\ProductController@exportProduct')->name('product.export')->middleware('auth:admin');
Route::get('products/print_barcode','SuperAdmin\ProductController@printBarcode')->name('product.printBarcode')->middleware('auth:admin');

Route::get('products/lims_product_search', 'SuperAdmin\ProductController@limsProductSearch')->name('product.search')->middleware('auth:admin');
Route::post('products/deletebyselection', 'SuperAdmin\ProductController@deleteBySelection')->middleware('auth:admin');
Route::post('products/update', 'SuperAdmin\ProductController@updateProduct')->middleware('auth:admin');
Route::resource('products', 'SuperAdmin\ProductController')->middleware('auth:admin');

});
Route::prefix('admin')->group(function(){
	Route::get('vendors/genpass', 'SuperAdmin\SuperAdminController@generatePassword');
	Route::resource('vendors','SuperAdmin\VendorController')->middleware('auth:admin');
});
	Route::get('admin/genpass', 'SuperAdmin\SuperAdminController@generatePassword');
	Route::resource('admin','SuperAdmin\SuperAdminController')->middleware('auth:admin');
...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::post('products/create', 'ProductController@createExistProduct')->name('products.create2');
	Route::post('products/store', 'ProductController@storeExistProduct')->name('products.store2');
	...
	// added Routes
	Route::post("sales/generatecsv" , "SaleController2@generateCSV")->name('sales.csv');
	Route::get('sales/getproducttwo/{id}', 'SaleController2@getProduct')->name('sale.getproduct2');
	//
	...
	Route::get("getVar/{id}" , "VariantController@getvar")->name("getVar");
	...
	Route::get('sales/e-stock', 'SaleController@create2')->name('e-stock.create');
