...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        if($role->hasPermissionTo('employees-index')){
            ...
            $lims_employee_all = Employee::where('is_active', true)->where('vendor_id', $vendor_id)->get();
            $lims_department_list = Department::where('is_active', true)->where('vendor_id', $vendor_id)->get();
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('employees-add')){
            $lims_role_list = Role::where('is_active', true)->where('vendor_id', $vendor_id)->get();
