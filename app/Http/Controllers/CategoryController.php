...
class CategoryController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('category')) {
            $lims_categories = Category::where('is_active', true)->where('vendor_id', $vendor_id)->pluck('name', 'id');
            $lims_category_all = Category::where('is_active', true)->where('vendor_id', $vendor_id)->get();
    ...
    public function categoryData(Request $request)
    {
        ...
        $totalData = Category::where('is_active', true)->where('vendor_id' ,$vendor_id )->count();
    ...
    public function store(Request $request)
    {
        ...
        $lims_category_data['vendor_id'] = Auth::user()->v_id;
    ...
    public function destroy($id)
    {
        ...
        $lims_category_data = Category::findOrFail($id);
        $lims_category_data->is_active = false;
        $lims_product_data = Product::where('category_id', $id)->where('vendor_id', $vendor_id)->get();
        foreach ($lims_product_data as $product_data) {
            $product_data->is_active = false;
            $product_data->save();
        }
