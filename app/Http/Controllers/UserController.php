...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        if($role->hasPermissionTo('users-index')){
            ...
            $lims_user_list = User::where('is_deleted', false)->where('v_id' , $v_id)->get();
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('users-add')){
            $lims_role_list = Roles::where('is_active', true)->where('vendor_id', $vendor_id)->get();
            ...
            $lims_customer_group_list = CustomerGroup::where('is_active', true)->where('vendor_id', $vendor_id)->get();
