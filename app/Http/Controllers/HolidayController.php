...
class HolidayController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('holiday')) {
            ...
            $lims_holiday_list = Holiday::orderBy('id', 'desc')->where('vendor_id', $vendor_id)->get();
        }
        else {
            $approve_permission = false;
            $lims_holiday_list = Holiday::where('user_id', Auth::id())->where('vendor_id', $vendor_id)->orderBy('id', 'desc')->get();
        }
