    ...
    public function index()
    {
        ...
        if($role->hasPermissionTo('payroll')){
            ...
            if(Auth::user()->role_id > 2 && $general_setting->staff_access == 'own')
                $lims_payroll_all = Payroll::orderBy('id', 'desc')->where('user_id', Auth::id())->where('vendor_id', $vendor_id)->get();
            else
                $lims_payroll_all = Payroll::orderBy('id', 'desc')->where('vendor_id', $vendor_id)->get();
